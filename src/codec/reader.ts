...
export class ByteReader {
  ...
  /** Reads a BER integer as an unsigned 32-bit value: chunk IDs, byte lengths, element counts. */
  ...
  /** Reads a BER integer reinterpreted as a signed 32-bit value (scalar Int32 fields). */
  readBer(): number {
