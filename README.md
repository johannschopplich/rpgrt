...
rpgrt's format knowledge and its generated record tables (`vendor/liblcf-csv/`, `src/generated/`) come from EasyRPG's [liblcf](https://github.com/EasyRPG/liblcf), used under the MIT License. Thanks to the EasyRPG project.
